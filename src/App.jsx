    ...
    <>
      ...
      <div className='py-10'>
        ...
        <div className='flex justify-center pt-5'>
          <button onClick={handleSelectProducts} className={`${toggle === true ? 'bg-blue-700 text-white' : 'border border-gray-400 '} px-5 py-2 rounded-l-3xl text-blue-800 border border-gray-200 border-r-0 cursor-pointer`}>Products</button>
